...
To run the python file, just type 'python3 classifier.py'for SVM 
To run the python file, just type 'python3 nnet.py'for Neural Network Implementation. 
...
And a improvement 6% is made from original implementation. Earlier the accuracy was about 62% now we have 70% accurate model.
